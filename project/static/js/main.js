const questions = [
  {
    question:
      "Is the child free from any physical violence, psychological abuse or neglect ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Is the child protected from the use of hallucinogens, narcotics, alcohol, tobacco products or any other drugs ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Does the child have access to maintenance and support from a responsible parent ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Is the child exposed to appropriate facilities, infrastructure and disaster preparedness ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Is the child being cared for by a responsible parent or guardian ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Does the child have access to good quality health care, clean water, nutritious food and a clean environment ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Is the child engaged in learning in the formal education system ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Does the child have access to leisure, play and participate in extracurricular activities ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
  ...
  {
    question:
      "Does the child have basic life skills, values and attitudes necessary for survival and development ",
    options: [
      { text: "0", num: 0 },
      { text: "4", num: 4 },
      { text: "7", num: 7 },
...
function showQuestion(question) {
  questCount.innerText =
    questionCounter.toString() + " out of " + questionsArray.length.toString();
  questionElement.innerHTML =
    question.question +
    "<strong>*on a scale of 0 to 10 (0 = Not in interest, 10 = In Interest).</strong>";
